...
-- Dvorak spanish
hl.bind(mainMod .. " + d",  hl.dsp.focus({ direction = "left" }), { description = "Move focus left" })
hl.bind(mainMod .. " + r",  hl.dsp.focus({ direction = "down" }), { description = "Move focus down" })
hl.bind(mainMod .. " + t",    hl.dsp.focus({ direction = "up" }), { description = "Move focus up" })
hl.bind(mainMod .. " + n", hl.dsp.focus({ direction = "right" }), { description = "Move focus right" })

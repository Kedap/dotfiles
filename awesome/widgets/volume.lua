...
local widget_types = {
    icon_and_text = require("widgets.otros-wv.icon-and-text-widget"),
    icon = require("widgets.otros-wv.icon-widget"),
    arc = require("widgets.otros-wv.arc-widget"),
    horizontal_bar = require("widgets.otros-wv.horizontal-bar-widget"),
    vertical_bar = require("widgets.otros-wv.vertical-bar-widget")
}
local volume = {}

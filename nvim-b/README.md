...
### Solarizado
#### Startify
![solarizado_startify](./screenshots/solarizado_startify.png)
#### Navegando entre archivos (NERDTree)
![solarizado_nerd](./screenshots/solarizado_arbol.png)
#### Ejemplo de algún código escrito en Lua
![solarizado_ejemplo](./screenshots/solarizado_sample.png)

## [Duskfox](https://github.com/EdenEast/nightfox.nvim)
### Startify
![duskfox_startify](./screenshots/duskfox_startify.png)
### Navegando entre archivos (NERDTree)
![duskfox_nerd](./screenshots/duskfox_arbol.png)
### Ejemplo de algún código escrito en Lua

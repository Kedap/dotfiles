--
-- Dependencias: alsa-utils, feh, kitty, dunst, flameshot, betterlockscreen, xmobar
-- Configuraciones dependencientes: picom, kitty
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- bloquear y suspender la pantalla
    , ((modm,               xK_F1     ), spawn "~/bin/powermenu.sh")
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,15), (R,15), (U,15), (D,15)]) -- reset the GapSpec
    ...
    , ((modm .|. shiftMask, xK_f ), setLayout $ XMonad.layoutHook conf)
    ...
    -- Configuracion de atajos de sonido   
